...
return array(
    // 订单excel导出标题列表
    'excel_order_title_list' => array(
        'id'              => array('col' => 'A', 'name' => '订单id'),
        'user_name'       => array('col' => 'B', 'name' => '姓名'),
        'mobile_phone'    => array('col' => 'C', 'name' => '手机'),
        'department_text' => array('col' => 'D', 'name' => '部门'),
        'ship_text'       => array('col' => 'E', 'name' => '所属船舶'),
        'courier_text'    => array('col' => 'F', 'name' => '单号信息'),
        'status_text'     => array('col' => 'G', 'name' => '状态'),
