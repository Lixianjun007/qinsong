...
return array(
	...
	'order_department_list'			=> ['Deck', 'Food and beverage', 'Photography', 'Engine', 'Finance', 'Human Resources', 'Medical', 'Cruise program', 'Casino', 'Surveillance', 'Production / theater ', 'Guest entertainment', 'Hotel', 'Musician', 'Concession', 'Gallery', 'IT', 'Restaurant', 'Bar', 'House miscellaneous', 'Shore excursions','Housekeeping','Guest Services','Spa','Gift Shop','Art','Internet'],
	'order_ship_list'			=> ['NCL'],
