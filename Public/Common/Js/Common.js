...
$(function()
{
	...
	/**
	 * [submit-state 公共数据关闭操作]
	 * @author   Devil
	 * @blog     http://gong.gg/
	 * @version  0.0.1
	 * @datetime 2016-12-10T14:22:39+0800
	 * @param    {[int] 	[data-id] 	[数据id]}
	 * @param    {[int] 	[data-close][状态值]}
	 * @param    {[string] 	[data-url] 	[请求地址]}
	 */
	$(document).on('click', '.submit-close', function()
	{
		$('#common-confirm-close').modal({
			relatedTarget: this,
			onConfirm: function(options)
			{
				// 获取参数
	...
	/**
	 * [submit-state 公共数据完成操作]
	 * @author   Devil
	 * @blog     http://gong.gg/
	 * @version  0.0.1
	 * @datetime 2016-12-10T14:22:39+0800
	 * @param    {[int] 	[data-id] 	[数据id]}
	 * @param    {[int] 	[data-success][状态值]}
	 * @param    {[string] 	[data-url] 	[请求地址]}
	 */
	$(document).on('click', '.submit-success', function()
	{
		$('#common-confirm-success').modal({
			relatedTarget: this,
			onConfirm: function(options)
			{
				// 获取参数
